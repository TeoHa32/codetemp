...
public class productServlet extends HttpServlet {
	...
	public void searchProduct(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    if(name != null) {
	    	if(!name.equals("")) {
	    		List<product> list = products.searchProductByName(name);
				List<product> listAuthor=products.searchProductByAuthor(author);
			    if(!list.isEmpty()) {
			    	request.setAttribute("listSearch", list);
			    	request.setAttribute("search", "true");
			    	request.getRequestDispatcher("/view/admin.jsp?page=products").forward(request, response);
			    	
			    }
			    else if(!listAuthor.isEmpty()) {
			    	request.setAttribute("listSearch", listAuthor);
			    	request.setAttribute("search", "true");
			    	request.getRequestDispatcher("/view/admin.jsp?page=products").forward(request, response);
			    }
